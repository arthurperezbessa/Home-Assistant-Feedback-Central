...
from .const import DOMAIN, signal_new_report

# Quantas mensagens recentes manter por cliente.
MAX_RECENT = 10

# Chaves guardadas de cada mensagem (o cliente já é o do próprio sensor).
...
async def async_setup_entry(
    ...
    async_add_entities(
        ClientReportSensor(entry, client_id) for client_id in clients
    )
